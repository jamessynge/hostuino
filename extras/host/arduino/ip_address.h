#ifndef ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_IP_ADDRESS_H_
#define ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_IP_ADDRESS_H_
...
#endif  // ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_IP_ADDRESS_H_

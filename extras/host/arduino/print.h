#ifndef ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_PRINT_H_
#define ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_PRINT_H_
...
#endif  // ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_PRINT_H_

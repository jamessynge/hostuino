#ifndef ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_WSTRING_H_
#define ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_WSTRING_H_
...
#endif  // ARDUINO_HOSTUINO_EXTRAS_HOST_ARDUINO_WSTRING_H_

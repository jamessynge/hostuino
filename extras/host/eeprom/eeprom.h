#ifndef ARDUINO_HOSTUINO_EXTRAS_HOST_EEPROM_EEPROM_H_
#define ARDUINO_HOSTUINO_EXTRAS_HOST_EEPROM_EEPROM_H_
...
#endif  // ARDUINO_HOSTUINO_EXTRAS_HOST_EEPROM_EEPROM_H_
